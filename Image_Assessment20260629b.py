...
def thread_vb():
    ...
    while g_system_running:
        ...
        try:
            ...
            # Camera: only the private gate is cleared here - the PLC-facing g_plc_tx_camera_pass/fail fields
            # are cleared separately, on the Capture Results falling edge in thread_plc, since
            # execute_assessment() also legitimately writes to those same fields for a different reason.
