...
def thread_vb():
    ...
    while g_system_running:
        ...
        try:
            #============================= Send ============================================================
            # Gate on the PLC TX pass/fail fields: a trigger is sent only
...
#======================================= Receive ==============================================
            ...
            # Map VB's result bits straight onto the PLC TX pass/fail fields - no ambiguity now that
            # camera and barcode results have their own dedicated bits in VB's reply.
