    ...
    while g_system_running:
        ...
        try:
            ...
            if do_camera_send or do_barcode_send:
                ...
                # this guards against a LH or RH "required" bit getting through to VB when
                ...
                else:  #new addition to the gating, that gives us a way of dropping the bits to false when the PLC holds RH BC High but drops the capt barcode bit.
                    l_vb_lh_bc_trigger = 0
                    l_vb_rh_bc_trigger = 0
