...
def open_io_list_window():
    ...
    """
    gate_sec = add_column(columns_frame, "Internal Logic Gate States (debug)")
...
def thread_vb():
    ...
    while g_system_running:
        ...
        try:
            ...
            # drive the receive-side pass/fail mapping further down.
            ...
            # This only touches our own private gate state - never the PLC-facing pass/fail fields, which
            # execute_assessment() also legitimately writes to.
